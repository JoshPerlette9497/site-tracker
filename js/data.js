...
{id:uid(),name:'Pre-Cribbing',milestone:'Excavation',offsetDays:2,matchPhase:'',items:[{id:uid(),text:'booked structural rebar inspection where applicable (5-plex and up)'},{id:uid(),text:'flat hole + party walls cut lower'},{id:uid(),text:'sewer trench backfilled'},{id:uid(),text:'sewer trench slope correct for plumbers'}]},
{id:uid(),name:'Pre-Excavation',milestone:'Excavation',offsetDays:2,matchPhase:'',items:[{id:uid(),text:'Excavation addressing for inspections'},{id:uid(),text:'hydrodig utilities'},{id:uid(),text:'staked out'},{id:uid(),text:'Footing layout to visualize horizontal space + grade layout for vertical space'}]},
{id:uid(),name:'Pre-Undergrounds',milestone:'Excavation',offsetDays:2,matchPhase:'',items:[{id:uid(),text:'Electric backer panel installed'},{id:uid(),text:'Order gas riser and get Jess from ATCO on site to inspect and work order them'},{id:uid(),text:'MARK GRADES: unit numbers'},{id:uid(),text:'MARK GRADES: UTILITIES'},{id:uid(),text:'Support for gas riser'},{id:uid(),text:'Groundworks gravel'},{id:uid(),text:'MARK GRADES: LANDSCAPING'}]},
{id:uid(),name:'Pre-Backfill',milestone:'Excavation',offsetDays:2,matchPhase:'',items:[{id:uid(),text:'panel backer and meter banks installed (ladder/lift)'},{id:uid(),text:'water main tail stubbed out 8-10ft above grade in mech rooms (Heritage)'}]},
{id:uid(),name:'Pre-Framing',milestone:'Excavation',offsetDays:2,matchPhase:'',items:[{id:uid(),text:'Print/post/send all SI\'s/CO\'s/Selections + notify sticky trades'},{id:uid(),text:'Remove window well braces before framing, where applicable'},{id:uid(),text:'consolidate and notify trades of all IFC\'s/SI/Selections'}]},
{id:uid(),name:'FRAME CHECK: Pre-IPD',milestone:'Framing',offsetDays:5,matchPhase:'',items:[{id:uid(),text:'Joists/trusses accessible for fire stopping'},{id:uid(),text:'Tubs/showers fit AFTER drywall'},{id:uid(),text:'Braces removed'},{id:uid(),text:'Concrete floors flat for flooring install; line up self-leveling'}]},
{id:uid(),name:'FRAME CHECK: Exterior',milestone:'Framing',offsetDays:5,matchPhase:'',items:[{id:uid(),text:'Correct fascia size'},{id:uid(),text:'insulation stops secure to building exterior'},{id:uid(),text:'entry doors operate'},{id:uid(),text:'exterior sheathing lifting holes patched'},{id:uid(),text:'Roof access hatch cut'},{id:uid(),text:'Soffit backing'},{id:uid(),text:'Roof vents cut'},{id:uid(),text:'DensGlass firestopping in proper areas'},{id:uid(),text:'Exterior sheathing flush for siding/stone'}]},
{id:uid(),name:'FRAME CHECK: ALL Rooms',milestone:'Framing',offsetDays:5,matchPhase:'',items:[{id:uid(),text:'1)architectural/structural 2) mechanical 3) drywallers'},{id:uid(),text:'Windows work/correct RO'},{id:uid(),text:'HVAC holes cut/framed'},{id:uid(),text:'Walls and ceilings level/straight/square'},{id:uid(),text:'Light switch locations are convenient'},{id:uid(),text:'top floor insulation stops secure'},{id:uid(),text:'Fire stopped properly at party walls and trusses + no party wall spacer blocks'},{id:uid(),text:'Doors work/correct RO'},{id:uid(),text:'check structural details in all areas where necessary'},{id:uid(),text:'Plumbing walls installed prior to cabinet mark out'},{id:uid(),text:'Floors flat and no deflection/squeaks'},{id:uid(),text:'UNITS CLEANED AND SWEPT'},{id:uid(),text:'top floor attic hatch installed'},{id:uid(),text:'Can it batt insulate/foam insulate/blown insulate/poly/board/tape?'},{id:uid(),text:'top floor uplift blocks'}]},
{id:uid(),name:'FRAME CHECK: Garage',milestone:'Framing',offsetDays:5,matchPhase:'',items:[{id:uid(),text:'door cripples point loaded to garage slab; see structural detail where necessary'},{id:uid(),text:'Exterior and Garage to house doors operate'},{id:uid(),text:'OH door backing'}]},
{id:uid(),name:'FRAME CHECK: Powder Room/Bathrooms',milestone:'Framing',offsetDays:5,matchPhase:'',items:[{id:uid(),text:'TP and towel bar backing installed correct location/height'},{id:uid(),text:'Mirrors on flat/level walls'},{id:uid(),text:'studs @ 20in from back of tub to anchor water lines and valves'},{id:uid(),text:'Joists don\'t compete with plumbing'},{id:uid(),text:'Tub/shower fits AFTER IPD @ 60in length'}]},
{id:uid(),name:'FRAME CHECK: Kitchen',milestone:'Framing',offsetDays:5,matchPhase:'',items:[{id:uid(),text:'(Heritage model) plumbing wall set with 1in gap from exterior wall to give HVAC heat run 7in of room'},{id:uid(),text:'cabinet backing @ 36in and 93in from floor OR studs @ 16in OC'}]},
{id:uid(),name:'FRAME CHECK: Laundry',milestone:'Framing',offsetDays:5,matchPhase:'',items:[{id:uid(),text:'minimum 36in laundry machine depth after plumbing walls (Heritage models)'}]},
{id:uid(),name:'FRAME CHECK: Stairs',milestone:'Framing',offsetDays:5,matchPhase:'',items:[{id:uid(),text:'Stairs centered on stairwells and doors/openings'},{id:uid(),text:'Under stairs backing'},{id:uid(),text:'Stair nosing on/off per selections'},{id:uid(),text:'Handrail backing correct at main runs/winders/landings'},{id:uid(),text:'Baseboard area STRAIGHT'},{id:uid(),text:'headroom correct and sloped ceiling correct (check structural detail where necessary)'},{id:uid(),text:'stairs centered on FINISHED OPENING'},{id:uid(),text:'upper stairs 36in high stub wall correct height and anchored to floors system'}]},
{id:uid(),name:'FRAME CHECK: Living Room/Bedrooms',milestone:'Framing',offsetDays:5,matchPhase:'',items:[{id:uid(),text:'General room list'},{id:uid(),text:'Closet door RO\'s'}]},
{id:uid(),name:'FRAME CHECK: Mechanical Room',milestone:'Framing',offsetDays:5,matchPhase:'',items:[{id:uid(),text:'(Bella\'s) blocking to separate batts from foam insulation'},{id:uid(),text:'(Heritage model) underside of stairs backing @ 1ft OC for more holding power'}]},
{id:uid(),name:'FRAME CHECK: Decks/Porches',milestone:'Framing',offsetDays:5,matchPhase:'',items:[{id:uid(),text:'roof vent holes cut as required'},{id:uid(),text:'roof soffit dropped as necessary'},{id:uid(),text:'posts point loaded to sonotubes or slab'},{id:uid(),text:'deck posts built out as per architectural drawings'}]},
{id:uid(),name:'FRAME CHECK: Post-Rough-In\'s Backframing',milestone:'Framing',offsetDays:5,matchPhase:'',items:[{id:uid(),text:'OH door wall and ceiling backing'},{id:uid(),text:'underside of stairs backing @ 2ft on center'},{id:uid(),text:'firestopping drywall installed at winders/landings where next to party wall'},{id:uid(),text:'Ceiling drops: garages/powder rooms/Bella garage entry hallways'},{id:uid(),text:'Bulkheads'},{id:uid(),text:'handrail backing @ 32in on center; check at winders'},{id:uid(),text:'Bath fan backing'},{id:uid(),text:'Ceiling drop at deck soffit'},{id:uid(),text:'Top floor uplift blocks'},{id:uid(),text:'Garage OH door backing in middle, side posts, ceiling at 10ft in on tracks and 8ft in on motor'}]},
{id:uid(),name:'Pre-Rough-ins',milestone:'Framing',offsetDays:2,matchPhase:'',items:[{id:uid(),text:'Window sheets'},{id:uid(),text:'IPD completed'},{id:uid(),text:'Plumber roof penetrations'},{id:uid(),text:'Construction knobs'},{id:uid(),text:'Cabinets marked out'},{id:uid(),text:'Construction heat in basements or garages'},{id:uid(),text:'Blue mats inside garages and outside front entries for mud control'},{id:uid(),text:'All exterior spotless'}]},
{id:uid(),name:'Pre-HVAC rough-in',milestone:'Rough-In',offsetDays:2,matchPhase:'',items:[{id:uid(),text:'Plumbers sweep'},{id:uid(),text:'Plumbers cleaned up hole cuts'},{id:uid(),text:'verify plumber rough selections correct'},{id:uid(),text:'Plumbers reinstall studs taken out for moving tubs'}]},
{id:uid(),name:'Spray Paint',milestone:'Rough-In',offsetDays:2,matchPhase:'',items:[{id:uid(),text:'flooring layout'},{id:uid(),text:'all HVAC'},{id:uid(),text:'all electrical'}]},
{id:uid(),name:'Pre-rough city inspections',milestone:'Rough-In',offsetDays:2,matchPhase:'inspection',items:[{id:uid(),text:'shower head roughs at correct height 7ft max'},{id:uid(),text:'booked architectural and structural inspections + city inspections where applicable'},{id:uid(),text:'waterline pressure holding'},{id:uid(),text:'verify all rough selections correct'},{id:uid(),text:'gas exterior stub address tags'},{id:uid(),text:'gas line pressure holding'},{id:uid(),text:'Spray paint electric and HVAC (one color is fine)'},{id:uid(),text:'Spray paint checklist'},{id:uid(),text:'kitchen OTR vent and wiring centered on range and hidden by cabinet or shroud'},{id:uid(),text:'Sawdust sweep/vac'},{id:uid(),text:'Order gas meters'}]},
{id:uid(),name:'Pre-Insulation and Drywall',milestone:'Rough-In',offsetDays:2,matchPhase:'',items:[{id:uid(),text:'Drywall frame check (drywall foreman) is COMPLETE'},{id:uid(),text:'X4 furnace filters each unit'},{id:uid(),text:'All walls and floors can be insulated/boarded/taped with respect to mechanical installs'}]},
{id:uid(),name:'Pre-Boarding',milestone:'Rough-In',offsetDays:2,matchPhase:'',items:[{id:uid(),text:'HVAC hood fans proper location to cabinets'},{id:uid(),text:'Framed backing to tie-in insulation/poly'},{id:uid(),text:'Can I board it? Can I tape it?'},{id:uid(),text:'Walls straight for tile'},{id:uid(),text:'Floor cut sheets onto windows and tubs/showers'},{id:uid(),text:'Party wall studs installed'},{id:uid(),text:'Ceiling backing at intersections/dead ends'},{id:uid(),text:'Tub damage'}]},
{id:uid(),name:'Pre-Taping',milestone:'Drywall',offsetDays:2,matchPhase:'',items:[{id:uid(),text:'shower head holes not cut too large'},{id:uid(),text:'long hallways and stairs aren\'t wavy (dead bodies from frame check)'},{id:uid(),text:'OTR vent holes not cut too large'},{id:uid(),text:'Floor cut sheets onto windows and tubs/showers'},{id:uid(),text:'Buried mechanical items: switches/receptacles/bath fans'},{id:uid(),text:'corners straight for tile'},{id:uid(),text:'basement bulkheads steel framed'},{id:uid(),text:'Slokker door stops'}]},
{id:uid(),name:'Pre-S1',milestone:'Drywall',offsetDays:2,matchPhase:'',items:[{id:uid(),text:'spotless for priming'},{id:uid(),text:'CHANGE FURNACE FILTER'},{id:uid(),text:'textured, sanded, vacuumed on schedule'},{id:uid(),text:'Vacuum + wipe out showers and tubs'}]},
{id:uid(),name:'Pre-OTR',milestone:'Finishing',offsetDays:2,matchPhase:'',items:[{id:uid(),text:'tile/granite backsplash installed'},{id:uid(),text:'correct OTR/hood fans delivered as per selections/CO\'s'}]},
{id:uid(),name:'Pre-Flooring',milestone:'Finishing',offsetDays:2,matchPhase:'',items:[{id:uid(),text:'Floor cut sheets posted'},{id:uid(),text:'self-level concrete assessed and installed where applicable for LVP (AT FRAME CHECK IDEALLY DONE BEFORE DRYWALL START)'},{id:uid(),text:'Tubs cleaned out for tile workers'},{id:uid(),text:'S1 carpenters correct subfloor locations for tile'},{id:uid(),text:'CHANGE FURNACE FILTER'},{id:uid(),text:'baseboard installed at correct height carpet vs. LVP'},{id:uid(),text:'confirm correct flooring and tile delivered'}]},
{id:uid(),name:'Pre-S2 Carpentry',milestone:'Finishing',offsetDays:2,matchPhase:'',items:[{id:uid(),text:'floor protection put down'},{id:uid(),text:'cleaned/sweeped of garbage and dust'},{id:uid(),text:'S2 hardware correct delivery'},{id:uid(),text:'flooring done installation'},{id:uid(),text:'HVAC holes cut out'},{id:uid(),text:'Swiffer LVP'}]},
{id:uid(),name:'Pre-Trade Finals',milestone:'Finishing',offsetDays:2,matchPhase:'',items:[{id:uid(),text:'CHANGE FURNACE FILTER'},{id:uid(),text:'S2 carpenter done and cleaned up'},{id:uid(),text:'flooring done and ready for HVAC final'}]},
{id:uid(),name:'Pre-Final Inspection and Appliances',milestone:'Finishing',offsetDays:2,matchPhase:'',items:[{id:uid(),text:'con walk to-do list done (Slokker staff + YOU)'},{id:uid(),text:'CONSTRUCTION IS COMPLETE AND ALL IS READY FOR FINAL INSPECTION'},{id:uid(),text:'correct appliances delivered'},{id:uid(),text:'HERITAGES ONLY: remove laundry room doors and DAP baseboard'}]},
{id:uid(),name:'Con Walk and Pre-Occupancy',milestone:'Finishing',offsetDays:0,matchPhase:'construction walk through',items:[{id:uid(),text:'organize cabinets',subgroup:'Con Walk'},{id:uid(),text:'install BELLA powder room mirrors',subgroup:'Con Walk'},{id:uid(),text:'sweep/pressure wash garages/driveways/porches/decks/patios',subgroup:'Con Walk'},{id:uid(),text:'all mechanical OPERATIONAL AND SECURED',subgroup:'Con Walk'},{id:uid(),text:'WOCD locks OPERATIONAL AND SECURED',subgroup:'Con Walk'},{id:uid(),text:'garage door remotes x2 into kitchen drawer with all appliance manuals',subgroup:'Con Walk'},{id:uid(),text:'smoke detector shower caps',subgroup:'Con Walk'},{id:uid(),text:'paint tag out',subgroup:'Con Walk'},{id:uid(),text:'drydex garage man doors',subgroup:'Con Walk'},{id:uid(),text:'appliance clocks',subgroup:'Con Walk'},{id:uid(),text:'mechanical room spotless',subgroup:'Con Walk'},{id:uid(),text:'remove protective film on exterior door latches and sills',subgroup:'Con Walk'},{id:uid(),text:'CHANGE FURNACE FILTER',subgroup:'Con Walk'},{id:uid(),text:'bipass door bumpers',subgroup:'Con Walk'},{id:uid(),text:'handrail brackets reinstalled by painters',subgroup:'Con Walk'},{id:uid(),text:'black entry mat',subgroup:'Con Walk'},{id:uid(),text:'mech room panel labels',subgroup:'Stress Tests'},{id:uid(),text:'lights',subgroup:'Stress Tests'},{id:uid(),text:'smoke detectors',subgroup:'Stress Tests'},{id:uid(),text:'appliances',subgroup:'Stress Tests'},{id:uid(),text:'hot water tanks',subgroup:'Stress Tests'},{id:uid(),text:'bath fans',subgroup:'Stress Tests'},{id:uid(),text:'ventilation fan switch',subgroup:'Stress Tests'},{id:uid(),text:'outlets/switches',subgroup:'Stress Tests'},{id:uid(),text:'humidifier',subgroup:'Stress Tests'},{id:uid(),text:'tubs/sinks',subgroup:'Stress Tests'},{id:uid(),text:'exterior cleaned and graded for safety',subgroup:'Exterior Pre-Occ'},{id:uid(),text:'safe access to units',subgroup:'Exterior Pre-Occ'},{id:uid(),text:'utilities safe access and/or closed and secured',subgroup:'Exterior Pre-Occ'}]},
{id:uid(),name:'Possession',milestone:'Finishing',offsetDays:0,matchPhase:'possession',items:[{id:uid(),text:'cleaners done'},{id:uid(),text:'humidifier plugged in and ON'},{id:uid(),text:'check all sinks appliances WATER ON'},{id:uid(),text:'doors rekey'},{id:uid(),text:'cabinets organized'},{id:uid(),text:'appliance clocks'}]}
];
...
/* ---------- state ---------- */
let state = { units:[], master:[], instances:[], defs:[], schedule:[] };
let activeTab = 'today';
